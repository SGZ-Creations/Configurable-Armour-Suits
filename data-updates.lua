local function SetGridSize(grid_name, new_height, new_width)
  if data.raw.armor["equipment-grid"][grid_name] then
    data.raw.armor["equipment-grid"][grid_name].width = new_width
    data.raw.armor["equipment-grid"][grid_name].height = new_height
  end
end
